    ...
    <div className="mx-auto max-w-screen-xl px-4 py-8 sm:py-16 lg:px-6 h-full">
      ...
      <div className="justify-center space-y-8 md:grid md:grid-cols-2 md:gap-12 md:space-y-0 lg:grid-cols-3">
        ...
        <div className="flex flex-col items-center justify-center text-center">
          ...
          <p className="text-lg mt-2">OTP Requests</p>
        </div>
        ...
        <div className="flex flex-col items-center justify-center text-center">
          ...
          <h3 className="mb-2 text-xl font-bold dark:text-white">Payment Methods</h3>
          <p className="text-lg mt-2"> Custom options at will </p>
        </div>
        ...
        <div className="flex flex-col items-center justify-center text-center">
          ...
          <h3 className="mb-2 text-xl font-bold dark:text-white">Instant Support</h3>
        ...
        <div className="flex flex-col items-center justify-center text-center">
          ...
          <h3 className="mb-2 text-xl font-bold dark:text-white">Social Network</h3>
          <p className="text-lg mt-2">Save frequent member transactions</p>
        </div>
        ...
        <div className="flex flex-col items-center justify-center text-center">
          ...
          <h3 className="mb-2 text-xl font-bold dark:text-white">Texting</h3>
          <p className="text-lg mt-2">Member transaction responses </p>
        </div>
      </div>
    </div>
  )
